...
var CenterClient = (function (_super) {
    ...
    CenterClient.prototype.wacherNode = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var childMap, children, err_1, childrenPath, delNode, addNode;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (!(addNode.length > 0)) return [3, 6];
                    ...
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [4, Promise.all(children.filter(function (child) { return !addNode.includes(child); }).map(this.wacherData.bind(this, path)))];
                    case 7:
                        _a.sent();
                        return [2];
                }
    ...
    CenterClient.prototype.wacherData = function (nodePath, child) {
        return __awaiter(this, void 0, void 0, function () {
            var childrenNode, currentChild, childPath, data, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        err_2 = _a.sent();
                        childrenNode === null || childrenNode === void 0 ? void 0 : childrenNode.delete(child);
                        return [3, 4];
    ...
    CenterClient.prototype.listenerServer = function (serverPath, listener, polling) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                list.handler = setTimeout(function () {
                    var server;
                    try {
                        server = _this.getNextServer(serverPath);
                        if ((typeof list.prevServer === "undefined") ||
    ...
    CenterClient.prototype.subscribe = function (params, listener, isNeedWacherWeight) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var systemName, serviceName, serverPath, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
