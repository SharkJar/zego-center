...
var CenterClient = (function (_super) {
    ...
    CenterClient.prototype.subscribe = function (params, listener, isNeedWacherWeight) {
        ...
        rxjs_1.fromEvent(this, eventName.CHILDNODE_UPDATE + ":" + serverPath)
            .pipe(operators_1.switchMap(function (event) { return rxjs_1.of(_this.getNextServer(serverPath)); }), operators_1.debounceTime(300), operators_1.distinctUntilChanged(function (prev, next) { return (prev === null || prev === void 0 ? void 0 : prev.address) == (next === null || next === void 0 ? void 0 : next.address); }), operators_1.tap(function (server) { return _this.logger.log("[CenterClient-subscribe] \r\n \u83B7\u53D6\u5230\u7684\u6700\u65B0\u670D\u52A1\u5668:" + (server === null || server === void 0 ? void 0 : server.address) + ",serverPath:" + serverPath); }))
            .subscribe(noticeSubject);
    };
