...
var CenterClient = (function (_super) {
    ...
    CenterClient.prototype.distributionEvent = function () {
        var _this = this;
        var events = [eventName.NODE_CHILD_DELETE, eventName.CHILDNODE_DELETE, eventName.NODE_CHILD_ADD, eventName.CHILDNODE_ADD, eventName.CHILDNODE_UPDATE];
                    ...
                    case 1:
                        ...
                        if (!children || !Array.isArray(children) || children.length <= 0) {
                            ...
                            if (isExistsNode) {
                                ...
                                childrenPath.forEach(function (childPath) { return _this.emit(eventName.CHILDNODE_DELETE, { nodePath: path, childPath: childPath, childData: childMap === null || childMap === void 0 ? void 0 : childMap.get(childPath) }); });
                            }
                            return [2];
                        }
                        ...
                        if (delNode.length > 0) {
                            ...
                            delNode.forEach(function (childPath) { return _this.emit(eventName.CHILDNODE_DELETE, { nodePath: path, childPath: childPath, childData: childMap === null || childMap === void 0 ? void 0 : childMap.get(childPath) }); });
                        }
                    ...
                    case 1:
                        ...
                        try {
                            ...
                            if (data != JSON.stringify(currentChild.data)) {
                                this.emit(eventName.CHILDNODE_UPDATE, { nodePath: nodePath, childPath: child, prevChildData: currentChild.data, childData: result });
                            }
    ...
    CenterClient.prototype.getNextServer = function (path) {
        var childNodeMap = this.nodes.get(path);
    ...
    CenterClient.prototype.listenerServer = function (serverPath, listener) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, new Promise(function (res, rej) { resolve = res, reject = rej; })];
            });
        });
    };
    CenterClient.prototype.subscribe = function (params, listener) {
        return __awaiter(this, void 0, void 0, function () {
