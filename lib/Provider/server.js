...
var CenterService = (function () {
    ...
    CenterService.prototype.stopNextTick = function () {
        this.isStartNextTick = false;
    };
    CenterService.prototype.startNextTick = function () {
        this.isStartNextTick = true;
    };
    ...
    CenterService.prototype.nextTick = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tasks, _a, weight, cpu, avg5, avg15, heap, currentTask, systemName, serviceName, serverIP, serverPort, isBreakZK, isNeedBreak, path, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(tasks.length >= 0 && this.isStartNextTick)) return [3, 10];
                    ...
                    case 3:
                        _b.trys.push([3, 8, , 9]);
                        systemName = currentTask.systemName, serviceName = currentTask.serviceName, serverIP = currentTask.serverIP, serverPort = currentTask.serverPort, isBreakZK = currentTask.isBreakZK;
                        isNeedBreak = (typeof isBreakZK === "function" ? isBreakZK : this.isBreakZk)(cpu, avg5, avg15, heap);
                        if (!isNeedBreak) return [3, 5];
                        return [4, this.helper.remove(Path.join(systemName, serviceName, serverIP + ":" + serverPort))];
                    case 4:
                        _b.sent();
                        return [3, 2];
                    case 5: return [4, this.registerZK(__assign(__assign({}, currentTask), { weight: weight }))];
                    case 6:
                        path = _b.sent();
