                        ...
                        return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        _a.trys.push([2, 4, , 5]);
                                        return [4, senderFunc.apply(void 0, args)];
                                    case 3:
                                        result = _a.sent();
                                        this.logger.log("[ZkHelper-initConstructor] \r\n \u8C03\u7528\u65B9\u6CD5:" + name + " \u8C03\u7528\u65B9\u6CD5\u53C2\u6570:" + JSON.stringify(args) + " \u8FD4\u56DE\u7ED3\u679C:" + JSON.stringify(result));
                                        return [3, 5];
                                    case 4:
                                        err_1 = _a.sent();
                                        this.logger.error("[ZkHelper-initConstructor] \r\n \u8C03\u7528\u65B9\u6CD5:" + name + " \u8C03\u7528\u65B9\u6CD5\u53C2\u6570:" + JSON.stringify(args) + " \u8C03\u7528\u51FA\u9519" + err_1);
                                        return [3, 5];
