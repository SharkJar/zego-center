...
var injectable_1 = require("../injector/injectable");
var empty = function () { };
var IDS = {
...
var ZkHelper = (function () {
    ...
    ZkHelper.prototype.getUseMethodNames = function () {
        return Object.getOwnPropertyNames(ZkHelper_1.prototype)
            .filter(function (key) { return !(["constructor", "helper", "createInstance", "hasConnect", "connect"].find(function (name) { return key == name; })) && typeof ZkHelper_1.prototype[key] === "function"; });
    };
    ...
    ZkHelper.prototype.setACL = function (path, acls, version) {
        ...
        return new Promise(function (res, rej) { resolve = res, reject = rej; });
    };
    ...
    ZkHelper.prototype.connect = function () {
        ...
        this.client.once('connected', function () { resolve != empty && resolve(), reject = resolve = empty, timeHandler && clearTimeout(timeHandler); });
        this.client.connect();
        timeHandler = setTimeout(function () { reject && reject(), reject = resolve = empty; }, 30 * 1000);
        return new Promise(function (res, rej) { resolve = res, reject = rej; });
    };
    ...
    ZkHelper = ZkHelper_1 = __decorate([
        ...
        __metadata("design:paramtypes", [logger_1.BusinessLogger, configService_1.ConfigService])
    ], ZkHelper);
    return ZkHelper;
}());
