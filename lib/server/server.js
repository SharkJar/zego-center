...
var CenterService = (function () {
    ...
    CenterService.prototype.nextTick = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tasks, weight, currentTask, path, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.nextHandler && clearTimeout(this.nextHandler);
                        tasks = Array.from(this.liveHeadTask.values());
                        if (!(tasks.length >= 0)) return [3, 8];
                        return [4, system_weight_1.GetSystemWeight()];
                    case 1:
                        weight = _a.sent();
                        this.logger.log("\u5F53\u524D\u8C03\u7528\u6CE8\u518C\u4E2D\u5FC3\u7684task:" + JSON.stringify(tasks) + ",\u5F53\u524D\u7684weight:" + weight, '[CenterService-nextTick]');
                        currentTask = void 0;
                        _a.label = 2;
                    case 2:
                        if (!(currentTask = tasks.shift())) return [3, 8];
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 6, , 7]);
